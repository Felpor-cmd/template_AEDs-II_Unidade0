...
public abstract class Produto {
    ...
    public boolean equals(Object obj) {
        if (obj instanceof Produto) {
            ...
            outro.descricao = outro.descricao.toLowerCase();
    ...
    static Produto criarDoTexto(String linha) {
          ...
          * é do tipo 1 ou 2, e instanciar o objeto adequado, com os dados fornecidos e
          * de acordo com seu tipo. O objeto
         ...
         if (tipo == 1) {
              ...
              return new ProdutoPerecivel(descricao, precoCusto, dataValidade);
         } else {
